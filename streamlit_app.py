...
if st.session_state.app_view == "HOME":
    ...
    with st.container(key="temperature_map_card"):
        ...
        if home_field_view == "3D":
            home_fig = make_true_3d_field(current_coords, current_temp_nodes, height=410, show_sensors=False, temp_max=32.0)
        else:
            home_fig = make_2d_heatmap(field_current_grid, height=315, show_sensors=False, temp_max=32.0)
...
# ============================================================
    ...
    if not st.session_state.has_run_optimization:
        ...
        recommendation_html = (
            ...
            f'<div class="hvac-mini-card">'
            f'<div><div class="hvac-mini-label">필요 냉방능력</div>'
            ...
            f'</div>'
            f'<div class="hvac-card-note">후보 범위 내 상대 냉방능력</div>'
            f'</div>'
