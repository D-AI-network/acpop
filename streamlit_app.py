...
def temperature_map(
    ...
    ax.set_title(f"{title} · z={target_z:g} m", fontsize=12, fontweight="bold")
    ...
    if "last_result" not in st.session_state:
        ...
        st.markdown(
            ...
            <div class="pf-shell" style="padding-top:0;padding-bottom:0">
              ...
              <div class="pf-card">
                <div class="pf-label">🔥 현재 가장 더운 위치</div>
                <div class="pf-temp" style="font-size:28px">{float(hottest["current_estimated_temp_C"]):.2f}℃ → {float(hottest["recommended_pred_temp_C"]):.2f}℃</div>
                <div class="pf-blue-text">
                  ...
                  예상 냉각 {float(hottest["expected_cooling_C"]):.2f}℃
                </div>
              </div>
              <div class="pf-metric-grid">
              ...
              <div class="pf-note">현재 값은 센서 실측이 아니라 현재 HVAC 설정 + 입력 열부하에 대한 PopField 정상상태 추정입니다.</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
